...
beta = ['0', '1', 'B', 'b', '#', 'H', 'S', 's', 'M', 'm','!','$','k','K','p']
alfa = ['0', '1', 'B', 'b', '#', 'H', 'S', 's', 'M', 'm','!','$','k','K','p']
mapping = {'B':'b',
           'H':'#',
           's':'S',
           'm':'M',
...
print (expand_rules(example_rule_alfa_enc_not_equal, alfa, beta))
# print (expand_rules(example_rule_alfa_enc_equal, alfa, beta))
#print (expand_rules(example_rule_alfa, alfa, beta))